...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create Table Users (email TEXT primary key, password TEXT, id TEXT,type TEXT)");
    }
    ...
    public boolean insertData(String id, String email, String password,String type){
